...
export default function Dashboard() {
    ...
    return (
        <>
            ...
            <div className='grid grid-cols-3 grid-rows-2 align-center justify-center items-center text-center'>
                ...
                <div>
                    <div className='w-1/1 h-auto text-[2rem] font-bold text-center mt-4'>Temperatures over 7 days</div>
                    <div className='w-1/1 h-auto items-center'>
                        <div className='self-center w-3/4 h-auto ml-[10%]'>
